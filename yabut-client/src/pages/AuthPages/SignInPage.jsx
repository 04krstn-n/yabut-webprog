  ...
  return (
    <>
      <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-zinc-500">
        Welcome Back to Draft & Drift</p>

      <h1 className="mt-3 text-3xl font-bold tracking-tight text-zinc-900 sm:text-4xl">
        Sign In</h1>

      <p className="mt-3 text-sm leading-7 text-zinc-600">
        Log in to access your purchased digital products, manage your account,
        and continue exploring curated creative assets.</p>
      ...
      <form className="mt-8 space-y-5">
        ...
        <div>
          ...
          <p className="mt-2 text-xs leading-5 text-zinc-500">
            Ensure your account credentials are secure to protect your digital
            purchases.</p>
        </div>
